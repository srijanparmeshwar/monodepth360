...
%rotate Rotate the equirectangular image by s degrees horizontally and t
% degrees vertically.
    ...
    output_image(:, :, 1) = interp2(input_image(:, :, 1), U, V, 'linear');
    output_image(:, :, 2) = interp2(input_image(:, :, 2), U, V, 'linear');
    output_image(:, :, 3) = interp2(input_image(:, :, 3), U, V, 'linear');
